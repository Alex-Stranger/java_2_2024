...
public class MedicalRiskLimitLevelSwitchOffIntegrationTest {

    @Autowired
    private TravelPremiumUnderwriting premiumUnderwriting;

    @Test
    public void medicalRiskLimitLevelEnabled() {
        ...
        assertEquals(result.getTotalPremium(), new BigDecimal("15.40"));
