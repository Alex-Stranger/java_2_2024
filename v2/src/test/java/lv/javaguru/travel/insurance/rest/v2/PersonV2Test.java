...
public class PersonV2Test {
    ...
    void testAgreementCases(String caseFolder) throws Exception {
        String requestPath = "rest/v2/person/" + caseFolder + "/request.json";
        String responsePath = "rest/v2/person/" + caseFolder + "/response.json";
    ...
    static Stream<String> testCaseProvider() {
        try {
            Path basePath = Paths.get(Objects.requireNonNull(
                    AgreementV1Test.class.getClassLoader().getResource("rest/v2/person")
            ).toURI());
