...
public class MedicalRiskLimitLevelSwitchOnIntegrationTest {

    @Autowired
    private TravelPremiumUnderwriting premiumUnderwriting;

    @Test
    public void medicalRiskLimitLevelDisabled() {
        PersonDTO person = PersonDTOBuilder.createPerson()
                .withPersonFirstName("Tom")
        ...
        AgreementDTO agreement = AgreementDTOBuilder.createAgreement()
                .withDateFrom(createDate("2025.05.25"))
                .withDateTo(createDate("2025.05.29"))
                .withCountry("JAPAN")
        ...
        assertEquals(result.getTotalPremium(), new BigDecimal("18.48"));
