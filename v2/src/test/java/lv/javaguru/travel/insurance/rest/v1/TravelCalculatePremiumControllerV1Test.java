...
public abstract class TravelCalculatePremiumControllerV1Test {
    ...
    private String getRequestFilePath() {
        return "rest/v1/" + getTestCaseFolderName() + "/request.json";
    }

    private String getResponseFilePath() {
        return "rest/v1/" + getTestCaseFolderName() + "/response.json";
    }
    ...
    private void executeAndEvaluate(String jsonRequestFilePath, String jsonResponseFilePath, boolean ignoreUUIDValue) throws Exception {
        ...
        MvcResult calculatedResult = mockMvc.perform(post("/insurance/travel/api/v1/")
                        .content(jsonRequest)
