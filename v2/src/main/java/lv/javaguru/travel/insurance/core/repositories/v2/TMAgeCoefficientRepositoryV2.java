...
public interface TMAgeCoefficientRepositoryV2 extends JpaRepository<TMAgeCoefficient, Long> {

    @Cacheable(value = "tmAgeCoefficientV2", key = "#p0", cacheManager = "cacheManagerV2")
