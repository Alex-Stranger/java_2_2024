...
public interface TCAgeCoefficientRepositoryV2 extends JpaRepository<TCAgeCoefficient, Long> {

    @Cacheable(value = "tcAgeCoefficientV2", key = "#p0", cacheManager = "cacheManagerV2")
