...
public interface ClassifierValueRepositoryV2 extends JpaRepository<ClassifierValue, Long> {

    @Cacheable(value = "classifierValueV2", key = "#p0 + '_' + #p1", cacheManager = "cacheManagerV2")
