...
class AgreementDTOLoader {
    ...
    private void loadPersons(AgreementDTO dto, AgreementEntity agreement) {
        ...
        List<PersonDTO> persons = personEntities.stream()
                .map(personEntity -> {
                    ...
                    personDTO.setPersonalCode(personEntity.getPerson().getPersonalCode());
                    ...
                    personDTO.setRisks(agreementPersonRisksEntityRepository.findByAgreementPerson(personEntity)
                            .stream()
    ...
    private void loadSelectedRisks(AgreementDTO dto, AgreementEntity agreement) {
        dto.setSelectedRisks(selectedRisksEntityRepository.findByAgreement(agreement)
