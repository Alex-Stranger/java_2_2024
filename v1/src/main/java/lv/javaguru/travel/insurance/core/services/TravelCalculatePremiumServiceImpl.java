...
class TravelCalculatePremiumServiceImpl implements TravelCalculatePremiumService {
    ...
    private TravelCalculatePremiumResponseV1 createResponse(List<ValidationError> errors) {
        return new TravelCalculatePremiumResponseV1(errors);
    }

    private TravelCalculatePremiumResponseV1 createResponse(TravelCalculatePremiumRequestV1 request, TravelPremiumCalculationResult premiumCalculationResult) {
